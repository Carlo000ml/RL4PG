...
class GP_Manager:
    def __init__(
        ...
        # graph processors
        if lines:
            self.main_gp = Graph_processor_lines(
                environment=grid2openv,
                input_dim=input_dim,
                n_mp=n_mp,
                type=type,
                dropout=dropout,
            ...
            self.target_gp = Graph_processor_lines(
                environment=grid2openv,
                input_dim=input_dim,
                n_mp=n_mp,
                type=type,
            ...
            self.main_gp = Graph_processor_sub(
                environment=grid2openv,
                input_dim=input_dim,
                n_mp=n_mp,
                type=type,
            ...
            self.target_gp = Graph_processor_sub(
                environment=grid2openv,
                input_dim=input_dim,
                n_mp=n_mp,
                type=type,
        ...
        self.optimizer = torch.optim.Adam(
            self.main_gp.parameters(), lr=lr, weight_decay=weight_decay
        )
